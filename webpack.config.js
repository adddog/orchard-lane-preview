  ...
  return {
    ...
    resolve: {
      ...
      modules: [
        ...
        resolve(`${constants.SRC_DIR}`, "store"),
        resolve(`${constants.SRC_DIR}`, "views"),
        resolve(`${constants.SRC_DIR}`, "gl"),
        resolve(`${constants.SRC_DIR}`, "api"),
        resolve(`${constants.SRC_DIR}`, "utils"),
      ],
    },
    node: {
      fs: "empty",
      ...
      rules: [
        {
          ...
          exclude: /node_modules\/(?!(inferno-bootstrap)\/).*/,
          use: ["babel-loader"],
        },
      ],
    },
